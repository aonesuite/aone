...
// generateTypeScriptTemplate renders a TypeScript template definition using
// the sandbox SDK builder pattern.
func generateTypeScriptTemplate(r *sandbox.DockerfileConvertResult) string {
	var b strings.Builder
	b.WriteString("// Code generated by `aone sandbox template migrate`. Edit as needed.\n")
	b.WriteString("import { Template } from '@aonesuite/sandbox'\n\n")
...
// generatePythonTemplate renders a Python template definition using the
// sandbox SDK builder pattern.
func generatePythonTemplate(r *sandbox.DockerfileConvertResult) string {
	var b strings.Builder
	b.WriteString("# Code generated by `aone sandbox template migrate`. Edit as needed.\n")
	b.WriteString("from aonesuite.sandbox import Template\n\n")
