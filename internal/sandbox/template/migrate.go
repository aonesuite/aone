...
func Migrate(info MigrateInfo) {
	...
	converted, err := dockerfile.Convert(content)
	if err != nil {
...
func writeMigratedTemplate(root, name, language string, r *dockerfile.ConvertResult) error {
	var (
		outputFile string
		body       string
	)
...
func generateGoTemplate(name string, r *dockerfile.ConvertResult) string {
...
func generateTypeScriptTemplate(r *dockerfile.ConvertResult) string {
	var b strings.Builder
	b.WriteString("// Code generated by `aone sandbox template migrate`. Edit as needed.\n")
...
func generatePythonTemplate(r *dockerfile.ConvertResult) string {
	var b strings.Builder
	b.WriteString("# Code generated by `aone sandbox template migrate`. Edit as needed.\n")
