...
const file_filesystem_filesystem_proto_rawDesc = "" +
	...
	"\rRemoveWatcher\x12 .filesystem.RemoveWatcherRequest\x1a!.filesystem.RemoveWatcherResponseB\xb4\x01\n" +
	"\x0ecom.filesystemB\x0fFilesystemProtoP\x01ZIgithub.com/aonesuite/aone/packages/go/sandbox/internal/envdapi/filesystem\xa2\x02\x03FXX\xaa\x02\n" +
	"Filesystem\xca\x02\n" +
