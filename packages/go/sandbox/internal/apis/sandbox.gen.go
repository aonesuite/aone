...
type SnapshotInfo struct {
	// Names Full names of the snapshot template including namespace and tag (e.g. namespace/my-snapshot:v2)
	Names []string `json:"names"`

	// SnapshotID Identifier of the snapshot template including the tag. Uses namespace/alias when a name was provided (e.g. namespace/my-snapshot:default), otherwise falls back to the raw template ID (e.g. abc123:default).
...
type Template struct {
	...
	// Public Whether the template is public or only accessible privately
