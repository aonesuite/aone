...
func (c *Client) CreateVolume(ctx context.Context, name string) (*Volume, error) {
	...
	resp, body, err := c.api.DoJSON(ctx, http.MethodPost, "/api/v1/sbx/volumes", map[string]string{"name": name}, &out)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetVolumeInfo(ctx context.Context, volumeID string) (*Volume, error) {
	var out apis.VolumeAndToken
	resp, body, err := c.api.DoJSON(ctx, http.MethodGet, "/api/v1/sbx/volumes/"+url.PathEscape(volumeID), nil, &out)
	if err != nil {
		return nil, err
	}
...
func (c *Client) ListVolumes(ctx context.Context) ([]VolumeInfo, error) {
	var out []VolumeInfo
	resp, body, err := c.api.DoJSON(ctx, http.MethodGet, "/api/v1/sbx/volumes", nil, &out)
	if err != nil {
		return nil, err
	}
	if resp.StatusCode != http.StatusOK {
...
func (c *Client) DestroyVolume(ctx context.Context, volumeID string) (bool, error) {
	resp, body, err := c.api.DoJSON(ctx, http.MethodDelete, "/api/v1/sbx/volumes/"+url.PathEscape(volumeID), nil, nil)
	if err != nil {
		return false, err
	}
